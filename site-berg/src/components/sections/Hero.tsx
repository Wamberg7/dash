  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-8 z-10 relative">
        ...
        <button
          onClick={() => scrollToSection('clients')}
          className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce hidden md:block cursor-pointer hover:scale-110 transition-transform"
          aria-label="Ir para próxima seção"
        >
          <ArrowDown className="w-6 h-6 text-zinc-600 hover:text-zinc-400" />
        </button>
      </div>
    </section>
  )
