...
const formSchema = z.object({
  ...
  serverId: z.string().min(10, { message: 'ID do servidor inválido.' }),
...
export default function BotSetup() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      // Calcular datas de assinatura (30 dias a partir de hoje)
      const startDate = new Date()
      const expiryDate = new Date()
      expiryDate.setDate(expiryDate.getDate() + 30) // Adicionar 30 dias

      await updateOrder(orderId, {
        botToken: values.botToken,
        serverId: values.serverId,
        ownerId: values.ownerId,
        botStatus: 'waiting', // Mudar para 'waiting' após configurar
      ...
      toast({
        ...
        description:
          'Seus dados foram salvos com sucesso. Seu bot será ativado em breve.',
      })
